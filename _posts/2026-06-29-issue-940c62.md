...
현재 검색량: 급상승 중 | 관련 뉴스: 1. T1 3:0 완승…'페이즈' 화력과 함께 KC 누르고 1일 최종전 진출 [MSI] (종합) - 네이트 | 2. [MSI] 페이즈의 칼리스타 앞세운 T1, TL 상대로 역전승 2:0 - 게임뷰 | 3. [MSI 브리핑] '무실점 전승 행진'...T1, KC마저 3대0 완파하고 최종진출전 선착 - 테크M | 4. OK저축은행, 이란 국적 ‘202㎝ MB’ 페이즈 영입 - 문화일보 | 5. 페이즈크래프트, 이리듐 적은 양자 설계 수소 촉매 개발 추진 - 가스신문
...
**페이즈** — 이 키워드가 갑자기 급상승한 데에는 분명한 이유가 있습니다.
